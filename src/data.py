...
class CustomDataset(IterableDataset):
    ...
    def __next__(self):
        ...
        return [torch.LongTensor(tokens), torch.LongTensor(segment_ids), is_next, torch.LongTensor(masked_lm_positions), torch.LongTensor(masked_lm_labels)]